...
class RemoveItemHandlerTest {
    ...
    private RemoveItemHandler handler;
    ...
    void setUp() {
        ...
        conversation = Conversation.builder()
                ...
                .restaurant(restaurant)
                .currentOrder(order)
                .state(ConversationState.REMOVE_ITEM)
                .build();
    ...
    @Test
    void getState_shouldReturnRemoveItem() {
    ...
    @Test
    void handle_shouldStayInRemoveItem_whenInvalidNumber() {
    ...
    @Test
    void handle_shouldStayInRemoveItem_whenSelectionIsZero() {
    ...
    @Test
    void handle_shouldStayInRemoveItem_whenSelectionIsNegative() {
